...
function Products() {
  ...
  <button onClick={() => showViewModal(product)} className="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded transition duration-300">
    See Details
  </button>
  ...
  <button onClick={() => deleteHandler(product.serialId)} className="bg-red-500 hover:bg-red-600 text-white px-4 py-2 rounded transition duration-300">
    Delete
  </button>
</div>
