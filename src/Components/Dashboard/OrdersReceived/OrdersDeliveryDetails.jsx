  ...
  return (
    <div className="container mx-auto p-6">
      <div className=" ">
        ...
        <div className="w-full md:w-1/2 p-4">
          <h3 className="text-blue-500 font-semibold text-lg mb-4">Order details</h3>
          ...
          <div className="grid grid-cols-2 gap-4 text-gray-500 text-sm">
            ...
            <div className="flex justify-start items-center ">
              <span className="font-medium text-base mr-5">Exact location:</span>
            ...
            <div className="flex justify-start items-center ">
              <span className="font-medium text-base mr-5">Delivery costs:</span>
            ...
            <div className="flex justify-start items-center ">
              <span className="font-medium text-base mr-5">Delivery location:</span>
